    ...
    $.fn.rowGrouping = function(options) {
        ...
        return this.each(function(index, elem) {
            ...
            function _fnGetCleanedGroup(sGroup) {
                ...
                if (sGroup === "") return "-";
                return sGroup.toString().toLowerCase().replace(/[^a-zA-Z0-9\u0080-\uFFFF]+/g, "-"); //fix for unicode characters (Issue 23)
            ...
            function fnExpandGroup(sGroup) {
                ...
                if (properties.oHideEffect != null)
                    $(".group-item-" + sGroup, oTable)[properties.oShowEffect.method](properties.oShowEffect.duration,
            ...
            function fnCollapseGroup(sGroup) {
                ...
                if (properties.oHideEffect != null)
                    $(".group-item-" + sGroup, oTable)[properties.oHideEffect.method](properties.oHideEffect.duration,
