(function() {
        ...
        window.nv.models.tooltip = function() {
            ...
            var contentGenerator = function(d) {
                ...
                theadEnter.append("tr")
                    ...
                    .text(headerFormatter(headerText));
                ...
                trowEnter.append("td")
                    .classed("value", true)
                    .text(function(p, i) {
                        var value = valueFormatter(p.value, i);
                        if (p.z1 != undefined && !isNaN(p.z1)) {
                            value = value + ' ( ' + p.z1.toFixed(2) + ' ) ';
                        }
                        return value;
                    });
    ...
    */
    ...
    nv.models.line = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                x0 = x.copy();
                y0 = y.copy();
                var dots = wrap.select('.nv-scatterWrap').selectAll('.nv-group');
                dots.attr('class', function(d, i) {
                    return d.class + ' nv-group  nv-series-' + i;
                })
            });
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                if (!data || !data.length || !data.filter(function(d) {
                    ...
                    container.select('.nv-wrap').remove();
                    return chart;
                } else {
                    container.selectAll('.nv-noData').remove();
                }
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                var availableWidth = (width || parseInt(container.style('width')) || 960) - margin.left - margin.right,
                    ...
                    lineClass = data.class;

                var dots = container.select('.nv-scatterWrap').selectAll('.nv-group');
                ...
                interactiveLayer.dispatch.on('elementMousemove', function(e) {
                    ...
                    var z1Value = xAxis.tickFormat()(singlePoint.z1);
                    interactiveLayer.tooltip
                        .position({
                            left: pointXLocation + margin.left,
                            top: e.mouseY + margin.top
    ...
    nv.models.BarWithFocusChartOnly = function() {
        "use strict";
        //============================================================
        // Public Variables with Default Settings
        //------------------------------------------------------------
    ...
    nv.models.multiBarFocusChart = function() {
        "use strict";
        //============================================================
        // Public Variables with Default Settings
        //------------------------------------------------------------
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                function onBrush() {
                    ...
                    focusLinesWrap.transition().duration(transitionDuration).call(multibar);
