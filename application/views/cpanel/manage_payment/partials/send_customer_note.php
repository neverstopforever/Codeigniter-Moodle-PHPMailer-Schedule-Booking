...
<header>
      ...
      <p style="color: #222;"><?php echo $this->lang->line('cpanel_hi'); ?> <strong><?php echo @$commercial_name; ?></strong></p>
      ...
      <?php } ?>
<!--      <p>--><?php //echo $this->lang->line('cpanel_paid_transfer_email_message_text4'); ?><!--<a href="--><?php //echo @$invoice_url; ?><!--" style="color: #5bbc2e;" target="_blank"> --><?php //echo $this->lang->line('paymentsystem_view_invoice'); ?><!--</a> </p>-->
<!--      <p style="color:#222;">--><?php //echo $this->lang->line('cpanel_paid_transfer_email_message_text4'); ?><!-- <a href="--><?php //echo $_base_url; ?><!--advancedSettings/billing_information?tab=subscribers_tab" style="color: #5bbc2e;" target="_blank"> --><?php //echo $this->lang->line('paymentsystem_view_invoice'); ?><!--</a> </p>-->
