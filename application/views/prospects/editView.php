                    ...
                    <div class="<?php echo $layoutClass ?>">
                        <div class="portlet light">
                            <div class="portlet-body">
                                <div class="col-md-12">
                                    <a href="<?php echo base_url() ?>leads" class="btn btn-success pull-right">&times;</a>
                                </div>
                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>
                                                            ...
                                                            <input type="text" class="form-control" readonly name="sNombre" maxlength="40" value="<?php echo $content[0]->sNombre; ?>" />
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>
                                                            ...
                                                            <input type="text" class="form-control" readonly name="sApellidos" maxlength="40" value="<?php echo $content[0]->sApellidos; ?>" />
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <label>
                                                            ...
                                                            <input type="text" class="form-control datepicker" name="Nacimiento"  value="<?php if($content[0]->Nacimiento) {echo ($lang == "english") ? Date('Y/m/d', strtotime($content[0]->Nacimiento)) : Date('d/m/Y', strtotime($content[0]->Nacimiento)); } ?>" />
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label>
                                                            ...
                                                            <textarea type="text" class="form-control" name="Asesor" style="min-height:100px;">
                                                                <?php
                                                                if (isset($personal_fields[0]->Asesor)) {
                                                                    echo $personal_fields[0]->Asesor;
                                                                }
                                                                ?>
                                                            </textarea>
                                                        </label>
                                                    ...
                                                    <div class="form-group">
                                                        <label>
                                                            ...
                                                            <textarea type="text" class="form-control" name="comentarios" style="min-height:100px;">
                                                                <?php
                                                                if (isset($personal_fields[0]->Asesor)) {
                                                                    echo $personal_fields[0]->comentarios;
                                                                }
                                                                ?>
                                                            </textarea>
                                                        </label>
