        ...
        <form method="post">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="add_seguimientoModalLabel"> <?php echo $this->lang->line('companies_addSeguimiento'); ?></h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>
                            <?php echo $this->lang->line(
                                'companies_followup_titulo'
                            ); ?>
                        </label>
        ...
        <form method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="<?php echo $this->lang->line('close'); ?>"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="edit_seguimientoModalLabel"> <?php echo $this->lang->line('companies_editrecord'); ?></h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>
...
<script src="<?php echo base_url(); ?>app/js/companies/partials/follow_up.js"></script>
