            ...
            <div class="page-content">
                <div class="<?php echo $layoutClass ?>">
                    <ul class=" page-breadcrumb breadcrumb">
                        ...
                        <li class="active">
                            <?php echo $this->lang->line('menu_contactos'); ?>
                        </li>
                    </ul>
                    ...
                    <div class="portlet light">
                        ...
                        <div class="quick_tips_sidebar margin-top-20">
                            <div class=" note note-info quick_tips_content">
                                ...
                                <p><?php echo $this->lang->line('contactos_quick_tips_text'); ?>
                                    <strong><a href="<?php echo $this->lang->line('contactos_quick_tips_link'); ?>" target="_blank"><?php echo $this->lang->line('contactos_quick_tips_link_text'); ?></a></strong>
                                </p>
                            </div>
                        </div>

                        <div class="nodata" style="display:none;text-align:center;">
<!--                            <a class="btn btn-primary btn-lg add_rcd" style="min-width:300px; min-height:80px;" href="--><?php //echo base_url() ?><!--/clientes/add"><i class="fa fa-plus"></i>--><?php //echo $this->lang->line('clientes_addRecord'); ?><!--</a>-->
                            <div class="text-center margin-top-30"><h3><?php echo $this->lang->line('looks_like_you_dont_have_any'); ?> <?php echo $this->lang->line('contact'); ?> </h3><a class="btn btn-primary btn-circle add_rcd margin-top-10" href="<?php echo base_url() ?>contactos/add"><i class="fa fa-plus"></i> <?php echo $this->lang->line('clientes_addRecord_persons'); ?></a></div>
                        </div>
                            ...
                            <div id="advancedSearchForm">
                                <div class="advancedSearchForm_wrapper" id="advancedSearchForm_wrapper">
                                    ...
                                    <div class="form-group clearfix" style="width:100%;">
                                        <button type="button" class="btn btn-info btn-circle btn-embossed applyFilter">
                                            <?php echo $this->lang->line('dt_apply') ?>
                                        </button>
                                        <button type="button" class="btn btn-info btn-circle btn-embossed resetTable">
                                    ...
                                    <div class="advancedgroupForm_wrapper" id="advancedgroupForm_wrapper">
                                        ...
                                        <a data-parent="#advancedgroup_accordion" href="#as_collapse0">
                                            <b class="item"><?php echo $this->lang->line('dt_groupTitle') ?> </b> <span class="pull-right" style="display:none"><?php echo $this->lang->line('dt_collapsExpand'); ?></span>
                                                ...
                                                <div id="as_collapse0" class="panel-collapse collapse in">
                                                    <div class="panel-body">
                                                        <div class="form-group clearfix  circle_select_div">
                                                            <h4><?php echo $this->lang->line('dt_selectColumn') ?></h4>
                                                            <div class="col-sm-6 margin-bottom-10">
                                                ...
                                                <div id="as_collapse0" class="panel-collapse collapse in">
                                                    <div class="panel-body">
                                                        <div class="form-group clearfix margin-bottom-10">
                                                            <div class="col-sm-12">
                                                                <div class="mbl margin-bottom-0 circle_select_div">
                                                                    <h4> <?php echo $this->lang->line('dt_chooseGroup') ?></h4>
                                        ...
                                        <div class="form-group clearfix">
                                            <button type="button" class="btn btn-info btn-circle btn-embossed resetTable pull-right">
                                                <?php echo $this->lang->line('dt_undo') ?>
                                            </button>
                                            <button type="button" class="btn btn-info btn-circle btn-embossed groupColumn">
                                                <?php echo $this->lang->line('dt_apply') ?>
                                            </button>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="contactosDeleteModal" role="dialog">
