...
<div class="page-lock">
    ...
    <div class="page-body">
       ...
       <div class="form-group">
           ...
           <input type="text" name="user_name" class="form-control" value="<?php echo $student->usuario; ?>" <?php echo  $student->usuario != '' ? 'disabled' : ''; ?> />
        ...
        <div class="form-group">
            <button type="button" id="create"  student_id="<?php  echo $student->id; ?>" class="btn btn-primary"><?php echo $this->lang->line('sign_up_create'); ?></button>
        </div>
    </div>
