                            ...
                            <div class="row inbox">
                                <div class="col-sm-3 text-center">
                                    ...
                                    <div class="compos_new_message">
                                            <button class="btn btn-block btn-primary btn-circle message_from" data-message_from="campose" data-title="Compose"  data-toggle="modal" data-target="#compose_modal">
                                                <i class="fa fa-plus"></i>
                                                <?php echo $this->lang->line('new_message') ?>
                                            </button>
                                        </div>
                                        <div class="inbox active io_active">
                                            <button   class="btn btn-block message_from btn-circle text-primary" data-message_from="inbox" data-title="Inbox"><?php echo $this->lang->line('button_msgInbox') ?>
                                            </button>
                                            <b></b>
                                        </div>
                                        <div class="sent io_active">
                                            <button class="btn btn-block message_from btn-circle text-primary" href="#" data-message_from="outbox"  data-title="Sent"><?php echo $this->lang->line('button_msgSent') ?>
                                            </button>
                                            <b></b>
                                        </div>
                                                    ...
                                                    <form class="form-horizontal" id="composemsg" method="POST" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="totype" id="totype" required>
                                                                    <option value=""><?php echo $this->lang->line('campus_select_to_type');?></option>
                                                                    <option value="0"><?php echo $this->lang->line('school');?></option>
                                                                    <option value="1"><?php echo $this->lang->line('campus_message_teachers');?></option>
                                                                </select>
                                                            </div>
                                                            <div id="to_select" style="display:none;">
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        ...
                                                                        <select name="to" id="to" class="allUsers form-control" required></select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
