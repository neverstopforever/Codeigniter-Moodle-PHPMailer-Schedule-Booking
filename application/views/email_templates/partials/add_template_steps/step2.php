<div class="row margin-top-20 step_header">    
    <h2 class="text-center step_title"><?php echo $this->lang->line('email_templates_step_title_2');?></h2>
</div>
<div class="row margin-top-20 text-center select_an_option">
    <div class="col-sm-4">
        <span class="icon-select-code"></span>
        <h2><?php echo $this->lang->line('email_templates_code');?></h2>
        <p><?php echo $this->lang->line('email_templates_code_text');?></p>
    ...
    <div class="col-sm-4">
        ...
        <h2><?php echo $this->lang->line('email_templates_basic');?></h2>
        <p><?php echo $this->lang->line('email_templates_basic_text');?></p>
    ...
    <div class="col-sm-4">
        ...
        <h2><?php echo $this->lang->line('email_templates_draft');?></h2>
        <p><?php echo $this->lang->line('email_templates_draft_text');?></p>
        <a href="#" class="btn btn-primary btn-circle select_continue" data-body_type="drafts" data-next_step="3"><?php echo $this->lang->line('select');?></a>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success next_step"><?php echo $this->lang->line("email_templates_insert"); ?></button>
            </div>
        </div>
    </div>
</div>