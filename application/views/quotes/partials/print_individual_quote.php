                ...
                <div class="page-content-inner">
                    <div class="invoice">
                        <div class="row invoice-logo">
                            <div class="col-xs-6 invoice-logo-space" style="float:left">
...
<!--                                    <li>--><?php //echo $this->lang->line('quotes_appointment_date'); ?><!--: --><?php //echo date($datepicker_format, strtotime($receipt->appointment_date)); ?><!-- </li>-->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <table class="table table-striped table-hover" style="border-collapse: collapse; border: 1px solid black;">
                                    <thead>
                                    <tr>
                                        <th style="border: 1px solid black;"><?php echo $this->lang->line('mi_quote_id'); ?> </th>
                                        <th style="border: 1px solid black;"><?php echo $this->lang->line('mi_reference'); ?> </th>
                                        <th style="border: 1px solid black;"> <?php echo $this->lang->line('date'); ?> </th>
                                        <th style="border: 1px solid black;"> <?php echo $this->lang->line('amount'); ?> </th>
                                        <th style="border: 1px solid black;"> <?php echo $this->lang->line('quotes_discount_to_apply'); ?> </th>
                                        <th style="border: 1px solid black;"> <?php echo $this->lang->line('mi_total_amount'); ?> </th>
                                        <?php if(isset($invoice) && $invoice == 1){ ?>
                                        <th style="border: 1px solid black;"> <?php echo $this->lang->line('quotes_invoiced'); ?> </th>
                                        <?php }?>
                                        <th style="border: 1px solid black;"> <?php echo $this->lang->line('mi_payment_method'); ?> </th>
                                        <th style="border: 1px solid black;"> <?php echo $this->lang->line('mi_state'); ?> </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
...
//                                      ?>
                                        <tr>
                                            <td style="border: 1px solid black;"> <?php echo $quote->quote_id;?> </td>
                                            <td style="border: 1px solid black;"> <?php echo $quote->reference;?> </td>
                                            <td style="border: 1px solid black;"> <?php echo date($datepicker_format, strtotime($quote->due_date));?> </td>

                                            <td style="border: 1px solid black;"> <?php echo $amount;?> </td>
                                            <td style="border: 1px solid black;"> <?php echo $discount;?> </td>
                                            <td style="border: 1px solid black;"> <?php echo $total_amount;?> </td>
                                            <?php if(isset($invoice) && $invoice == 1){ ?>
                                            <td style="border: 1px solid black;"> <?php echo $quote->invoice_id;?> </td>
                                            <?php } ?>
