<div id="documents_table" class="student_documents_table no_data_table">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/aws_s3/uploadDocuments/leads/<?php echo $client_id;?>" class="dropzone dropzone-file-area dz-clickable " method="POST" name="documents_import"
                      id="documents_import" >
...
<script src="<?php echo base_url(); ?>app/js/leads/partials/documents.js"></script>
