...
<!--                            </div>-->
                        ...
                        <div class="col-xs-8 text-right">
                            ...
                            <button class="btn btn-primary btn-circle" type="submit"><?php echo $this->lang->line('key_code_sign_in'); ?></button>
                        </div>
                    </div>
                </form>
                ...
                <form class="forget-form" action="javascript:;" method="post" >
                    ...
                    <div class="form-actions back_save_group">
                        ...
                        <button type="submit" id="forgot_password" class="btn btn-sm btn-primary btn-circle uppercase pull-right"><?php echo 'Submit'; //$this->lang->line('campus_submit'); ?></button>
                    </div>
                </form>
