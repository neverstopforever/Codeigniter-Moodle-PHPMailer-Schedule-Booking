<div id="addModal" class="modal fade" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="add_form" class="form-horizontal" method="POST" enctype="multipart/form-data">
...
<script src="<?php echo base_url(); ?>app/js/manage_invoices/partials/add.js"></script>