                        ...
                        <div class="row invoice-logo">
                            ...
                            <div class="col-xs-6">
                                <p class="uppercase"> <?php echo $this->lang->line('invoice'); ?>
                                    <span class="muted"> <?php echo $invoice_id; ?> </span>
                                </p>
                            </div>
                        </div>
                        <hr/>
...
<!--                                        <th class="hidden-xs"> --><?php //echo $this->lang->line('mi_description'); ?><!-- </th>-->
                                        <th> <?php echo $this->lang->line('mi_price_by_unit'); ?> </th>
                                        <th> <?php echo $this->lang->line('mi_units'); ?> </th>
                                        <th> <?php echo $this->lang->line('mi_vat'); ?> </th>
