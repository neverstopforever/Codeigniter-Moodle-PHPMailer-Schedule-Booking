                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control"  type="text" name="service" value="" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control"  type="text" name="reference_of_quote" value=""/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control float_type"  type="text" name="amount" value="0"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6 ">
                            <input class="form-control float_type" max="100" type="text" name="discount" value="0" />
                        </div>
                    </div>
...
<!--                            <input class="form-control float_type"  type="text" name="total" id="total" value="0" />-->
                        </div>
                    </div>
                    <hr/>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control"  type="text" name="appointment_date" value="<?php echo date($datepicker_format);?>"/>
...
<script src="<?php echo base_url(); ?>app/js/manage_invoices/partials/edit/add_free_quote.js"></script>