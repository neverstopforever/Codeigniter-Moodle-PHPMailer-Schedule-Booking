            ...
            <div class="portlet light">
                <div class="mt-element-step">
                    <div class="row step-line">
                        <div class="col-sm-2 mt-step-col first active col-sm-offset-1" id="template_step_1">
                            <div class="mt-step-number bg-white">1</div>
                            <div class="mt-step-title uppercase font-grey-cascade"><?php echo $this->lang->line('setup');?></div>
                            <div class="mt-step-content font-grey-cascade"><?php echo $this->lang->line('campaigns_step_title_1');?></div>
                        </div>
                        <div class="col-sm-2 mt-step-col" id="template_step_2">
                            <div class="mt-step-number bg-white">2</div>
                            <div class="mt-step-title uppercase font-grey-cascade"><?php echo $this->lang->line('style');?></div>
                            <div class="mt-step-content font-grey-cascade"><?php echo $this->lang->line('campaigns_step_title_2');?></div>
                        </div>
                        <div class="col-sm-2 mt-step-col" id="template_step_3">
                            <div class="mt-step-number bg-white">3</div>
                            <div class="mt-step-title uppercase font-grey-cascade"><?php echo $this->lang->line('compose');?></div>
                            <div class="mt-step-content font-grey-cascade"><?php echo $this->lang->line('campaigns_step_title_3');?></div>
                        </div>
                        <div class="col-sm-2 mt-step-col" id="template_step_4">
                            <div class="mt-step-number bg-white">4</div>
                            <div class="mt-step-title uppercase font-grey-cascade"><?php echo $this->lang->line('segment');?></div>
                            <div class="mt-step-content font-grey-cascade"><?php echo $this->lang->line('campaigns_step_title_4');?></div>
                        </div>
                        <div class="col-sm-2 mt-step-col last" id="template_step_5">
                            ...
                            <div class="mt-step-content font-grey-cascade"><?php echo $this->lang->line('campaigns_step_title_5');?></div>
                        </div>
                    </div>
                </div>
