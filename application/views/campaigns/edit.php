     ...
     <div class="table_loading"></div>
        <div class="page-content">
            <div class="<?php echo $layoutClass ?>">
                ...
                <div class="clear"></div>
                    <form class="form-horizontal" id="edit_campaign_form" data-campaign_id="<?php echo $campaign_id;?>" action="#" method="post">
                       <div>
                ...
                <div>
                    <div class="col-xs-12  ">
                        <div class="form-group">
                         <?php $this->load->view('campaigns/partials/edit_recipients', $this->data);?>
                        </div>
                    </div>
                </div>
