    ...
    <div class="page-header-top">
        ...
        <div class="<?php echo $layoutClass ?>">
            ...
            <div class="page-logo">
                ...
                $paid = $this->session->userdata('_cisess')['paid'];
                $plan = $this->session->userdata('_cisess')['plan'];
                    if((!empty($variables2->logo) && $paid != '0' && $plan != '1') || (!empty($variables2->logo)  && $plan == '1')){
...
<!--                <div class="redd">-->
        ...
        <!-- END MEGA MENU -->
            ...
            <div class="top-menu hidden-xs hidden-sm">
                <ul class="nav navbar-nav pull-right">
                    <!-- BEGIN NOTIFICATION DROPDOWN -->
                    <li class="dropdown dropdown-extended  dropdown-notification" id="header_help">
                        <a href="http://blog.akaud.com/" class="dropdown-toggle" title="<?php echo $this->lang->line('menu_Help'); ?>" target="_blank">
                    ...
                    <li class="dropdown dropdown-extended  dropdown-notification" id="header_notification_bar">
                        <a href="<?php echo base_url() ?>messaging" class="dropdown-toggle" >
                            <i class="<?php echo   @$notificationCount == '0' ? 'icon-envelope' : 'icon-envelope-open';?>"></i>
                            <span class="badge badge-default count count_new_messages" id="count_new_messages" style=" <?php echo   @$notificationCount == '0' ? 'display: none' : '';?>" ><?php echo @$notificationCount; ?></span>
                        </a>
                    </li>
                    <!-- END NOTIFICATION DROPDOWN -->
                    <!-- BEGIN TODO DROPDOWN -->
