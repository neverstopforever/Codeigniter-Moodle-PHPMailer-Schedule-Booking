	...
	<div class="footer">
		<div class="<?php echo $layoutClass ?>">
			<div class="row">
				...
				<div class="col-xs-6 private_terms_section"><p class="text-right"><a type="button" data-type="terms" class="terms_use terms_private"><?php echo $this->lang->line('footer_terms_use'); ?></a> <a data-type="private" class="private_police margin-left-20 terms_private"><?php echo $this->lang->line('footer_private_policy'); ?></a></p></div>
			</div>
		</div>
	</div>
</div>
...
<?php //if($this->router->fetch_class() != 'templates') { ?>
...
<!--<script src='//masonry.desandro.com/masonry.pkgd.js'></script>-->
