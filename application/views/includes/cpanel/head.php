...
<link href="<?php echo base_url() ?>assets/global/plugins/bootstrap-toastr/toastr.min.css" id="" rel="stylesheet" type="text/css" />

<!-- Dynamic styles -->
<link href="<?php echo base_url() ?>assets/admin/layout3/css/themes/dark_blue.css" rel="stylesheet" type="text/css" />
<!-- Dynamic styles -->
<!-- Dynamic styles -->
<!--<link href="--><?php //echo base_url() ?><!--assets/admin/layout3/css/themes/--><?php //echo !empty($color) ? $color : 'dark_blue.css'; ?><!--.css" rel="stylesheet" type="text/css" />-->
<!--added by controller-->
