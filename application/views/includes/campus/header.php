        ...
        <div class="<?php echo $layoutClass ?>">
            ...
            <div class="top-menu top-menu_first  visible-xs visible-sm">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-dark dropdown-notification campus_dropdown" id="header_notification_bar">
                        <a href="<?php echo $this->session->userdata('user_role') == '1' ?  base_url('campus/message') : base_url('campus/student-message'); ?>" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <i class="<?php echo   $campus_header_data['message_count'] == '0' ? 'icon-envelope' : 'icon-envelope-open';?>"></i>
                            <span class="badge badge-default count count_new_message" style="<?php echo   $campus_header_data['message_count'] == '0' ? 'display: none' : '';?>"><?php echo $campus_header_data['message_count'];?></span>
                        </a>
                    </li>
                    ...
                    <li class="dropdown dropdown-user ">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <img alt="" class="img-circle" src="<?php echo @$campus_header_data['imageUrl'];?>">
                            <span class="username username-hide-mobile"><?php echo @$campus_header_data['username'];?></span>
                        </a>
                        <?php
            ...
            <div class="top-menu  hidden-xs hidden-sm">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended  dropdown-notification campus_dropdown" id="header_notification_bar">
                        <a href="<?php echo $this->session->userdata('user_role') == '1' ?  base_url('campus/message') : base_url('campus/student-message'); ?> " class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="false">
                            <i class="<?php echo   $campus_header_data['message_count'] == '0' ? 'icon-envelope' : 'icon-envelope-open';?>""></i>
                            <span class="badge badge-default count count_new_message" style="<?php echo   $campus_header_data['message_count'] == '0' ? 'display: none' : '';?>"><?php echo $campus_header_data['message_count'];?></span>
                        </a>
                    </li>
        ...
        <div class="nav-justified">
            ...
            <ul class="list-items borderless">
                <li>
                    ...
                    <select class="form-control campus_languageChange">
                ...
                <li>
                    ...
                    <select class="form-control campus_themeColorChange">
                ...
                <li>
                    ...
                    <select class="form-control campus_layoutFormatChange">
