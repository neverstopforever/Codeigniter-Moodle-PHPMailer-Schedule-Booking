                            ...
                            <div class="tabbable" style="margin-bottom: 15px;">
                                <ul class="nav nav-tabs" style="margin-bottom:0;border-bottom: 6px solid #1f6a8c">
                                    <?php foreach ($teachers as $teacher){ ?>
                                        <li class="ab-calendar-tab" data-staff_id="<?php echo $teacher->teacher_id;?>" data-staff_color="<?php echo $teacher->color;?>" style="display: none">
                                            <a href="#" data-toggle="tab"><?php echo $teacher->teacher_name;?></a>
                                        </li>
                                    <?php }?>
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <label for="ab-filter-all-staff"><?php echo $this->lang->line('schedules_all_teachers');?></label>
                                                    </a>
                                                    <?php foreach ($teachers as $teacher){ ?>
                                                        <a style="padding-left: 35px;" href="javascript:void(0)">
                                                            <input style="margin-right: 5px;" type="checkbox" id="ab-filter-staff-<?php echo $teacher->teacher_id;?>" value="<?php echo $teacher->teacher_id;?>" data-staff_name="<?php echo $teacher->teacher_name;?>" class="ab-staff-filter left">
                                                            <label style="padding-right: 15px;" for="ab-filter-staff-<?php echo $teacher->teacher_id;?>"><?php echo $teacher->teacher_name;?></label>
                                                        </a>
                                                    <?php }?>
                                                </li>
                                            </ul>
