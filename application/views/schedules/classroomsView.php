                            ...
                            <div class="tabbable" style="margin-bottom: 15px;">
                                <ul class="nav nav-tabs" style="margin-bottom:0;border-bottom: 6px solid #1f6a8c">
                                    <?php foreach ($classrooms as $classroom){
                                        ...
                                        ?>
                                        <li class="ab-calendar-tab" data-staff_id="<?php echo $classroom->classroom_id;?>" data-staff_color="<?php echo $classroom->color;?>" style="display: none">
                                            <a href="#" data-toggle="tab"><?php echo $classroom->classroom_name;?></a>
                                        </li>
                                        <?php }
                                    }?>
                                                    ...
                                                    <?php foreach ($classrooms as $classroom){
                                                        if(!empty($classroom->classroom_name)){
                                                            ...
                                                            <a style="padding-left: 35px;" href="javascript:void(0)">
                                                                <input style="margin-right: 5px;" type="checkbox" id="ab-filter-staff-<?php echo $classroom->classroom_id;?>" value="<?php echo $classroom->classroom_id;?>" data-staff_name="<?php echo $classroom->classroom_name;?>" class="ab-staff-filter left">
                                                                <label style="padding-right: 15px;" for="ab-filter-staff-<?php echo $classroom->classroom_id;?>"><?php echo $classroom->classroom_name;?></label>
                                                            </a>
                                                        <?php }
                                                    }?>
                                                </li>
