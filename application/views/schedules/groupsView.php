                            ...
                            <div class="tabbable" style="margin-bottom: 15px;">
                                <ul class="nav nav-tabs" style="margin-bottom:0;border-bottom: 6px solid #1f6a8c">
                                    <?php foreach ($groups as $group){
                                        ...
                                        ?>
                                        <li class="ab-calendar-tab" data-staff_id="<?php echo $group->group_id;?>" data-staff_color="<?php echo $group->color;?>" style="display: none">
                                            <a href="#" data-toggle="tab"><?php echo $group->group_name;?></a>
                                        </li>
                                        <?php }
                                    }?>
                                                    ...
                                                    <?php foreach ($groups as $group){
                                                        if(!empty($group->group_name)){
                                                            ...
                                                            <a style="padding-left: 35px;" href="javascript:void(0)">
                                                                <input style="margin-right: 5px;" type="checkbox" id="ab-filter-staff-<?php echo $group->group_id;?>" value="<?php echo $group->group_id;?>" data-staff_name="<?php echo $group->group_name;?>" class="ab-staff-filter left">
                                                                <label style="padding-right: 15px;" for="ab-filter-staff-<?php echo $group->group_id;?>"><?php echo $group->group_name;?></label>
                                                            </a>
                                                        <?php }
                                                    }?>
                                                </li>
