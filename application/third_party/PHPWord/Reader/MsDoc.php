...
require_once APPPATH."/third_party/PhpWord/Shared/OLERead.php";;
require_once APPPATH."/third_party/PhpWord/Reader/AbstractReader.php";;
require_once APPPATH."/third_party/PhpWord/Reader/ReaderInterface.php";;
...
class MsDoc extends AbstractReader implements ReaderInterface
{
    ...
    private function loadOLE($filename)
    {
        ...
        $this->_DocumentSummaryInformation = $ole->getStream($ole->summaryInformation);
